...
public interface ResetPasswordController {
    ...
    boolean sendCodeEmail(@PathVariable String email);
     ...
     * @param email  用户邮件
     */
    @PostMapping("/verify_email_update_psw/{email}/{code}")
    boolean verifyEmailUpdatePsw(@PathVariable String code, @RequestParam String newPsw, @PathVariable String email);
